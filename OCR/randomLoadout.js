let weapons  = {
    ...
    "Winfield M1876 Centennial Shorty Silence": {
      "Capacity": "5+1/12",
      "Damage": 120,
      "Cycle Time": 1.6,
      "Vertical Recoil": 15,
    ...
    "Romero 77 Talon": {
      ...
      "Spread": 50,
      "Reload Speed": 3.4,
      "Heavy Melee Damage": 330,
      "Rate of Fire": 16,
      "Sway": 77,
      "Muzzle Velocity": 425,
      "Stamina Consumption": 33,
      "Price": 76,
      "Slot": "large"
    },
    ...
    "Bomb Lance": {
      ...
      "Light Stamina Consumption": 11,
      "Heavy Stamina Consumption": 50,
      "Price": 199,
      "Slot": "large"
    },
...
function randomizeLoadout() {
    ...
    // Separate weapons into large and small arrays
    for (const [weaponName, weaponData] of Object.entries(weapons)) {
        if (weaponData.Slot === "large") {
            largeWeapons.push(weaponName);
        } else if (weaponData.Slot === "small") {
            smallWeapons.push(weaponName);
        }
    }

    // Randomly select one large and one small weapon
    const randomLargeWeapon = largeWeapons[Math.floor(Math.random() * largeWeapons.length)];
    const randomSmallWeapon = smallWeapons[Math.floor(Math.random() * smallWeapons.length)];

    return {
        largeWeapon: randomLargeWeapon,
        smallWeapon: randomSmallWeapon
    };
}

// Example usage
const loadout = randomizeLoadout();
console.log("Your randomized loadout:");
console.log("Large weapon:", loadout.largeWeapon);
console.log("Small weapon:", loadout.smallWeapon);
